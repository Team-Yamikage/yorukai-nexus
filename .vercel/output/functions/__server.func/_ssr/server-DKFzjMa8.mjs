...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cd0lI_Lg.mjs");
...
const manifest = {
  "080a4be96bd626042b3dc87d063a86faef23f7ca0402e6628fde707e59335a2a": {
    functionName: "createBanFn_createServerFn_handler",
    importer: () => import("./admin-bans.functions-DOW8KNJn.mjs")
  },
  "1fb5cc3dc7ce900efc8c9f77e19c50f15d3fb28d551745e2f36ce4460f5f38d7": {
    functionName: "getEpisodeServersGuarded_createServerFn_handler",
    importer: () => import("./stream.functions-D-wp87dH.mjs")
  },
  "22326cdd89e837e282249dd5f4dc9752a5c1ae32a62a853d07097aea31ed8054": {
    functionName: "chapterPagesFn_createServerFn_handler",
    importer: () => import("./manga.functions-TpibSnij.mjs")
  },
  "327e71ee482e4be5fd4a435a9ca43e5a742f48dff583421f3673ae71823e89fa": {
    functionName: "mangaChaptersFn_createServerFn_handler",
    importer: () => import("./manga.functions-TpibSnij.mjs")
  },
  "3316eae9c1634831990523c1d3438b82a25dc9179bacb36e3021fc38fc7ba74e": {
    functionName: "revokeBanFn_createServerFn_handler",
    importer: () => import("./admin-bans.functions-DOW8KNJn.mjs")
  },
  "34d622c6f35c0a43d629b4a0cbd4bab5a00fe61dff33a3527bf78bd6bf2367a1": {
    functionName: "mangaDetailFn_createServerFn_handler",
    importer: () => import("./manga.functions-TpibSnij.mjs")
  },
  "3a05a354576130d8f79083a063c81b056fdd48df107dfe6c1910e2a81812b811": {
    functionName: "probeServers_createServerFn_handler",
    importer: () => import("./server-health.functions-cH4Ju8H3.mjs")
  },
  "77dd1524f14db3ed31b1d8b9422e6558fa1a4b86d43c975b87d896eb061a0b04": {
    functionName: "listBansFn_createServerFn_handler",
    importer: () => import("./admin-bans.functions-DOW8KNJn.mjs")
  },
  "8d75d4082cfa9203ed80219df9a77029cf555e19ce6e084d0ad48294f770ea95": {
    functionName: "liveChannelsFn_createServerFn_handler",
    importer: () => import("./iptv.functions-BBe-OK6S.mjs")
  },
  "cf163a37ce6862c7e2d0d008db2160c7b923e641268540dd49c2c85d2ba88753": {
    functionName: "mangaListFn_createServerFn_handler",
    importer: () => import("./manga.functions-TpibSnij.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-UGTBz-_d.mjs").then((n) => n.r),
    import("./start-BRoWcvdK.mjs"),
