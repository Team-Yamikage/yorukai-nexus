...
AS $function$
  ...
  WHERE episode_id = _episode_id
    ...
    -- Exclude ad-link shortener / broken-DNS hosts that redirect to ads
    AND stream_url !~* '://(www\.)?(short\.icu|shorturl|adf\.ly|ouo\.io|linkvertise|exe\.io|gplinks|za\.gl|clk\.sh)'
$function$;